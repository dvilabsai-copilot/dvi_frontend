...
- Transitional controller `ItineraryDetailsController.tsx`: 1,717 physical lines; it is explicitly documented as the remaining staging module to split by workflow.
