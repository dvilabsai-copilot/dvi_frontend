...
- Transitional controller `ItineraryDetailsController.tsx`: 6,047 physical lines; it is explicitly documented as the remaining staging module to split by workflow.
