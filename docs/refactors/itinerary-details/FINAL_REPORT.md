...
- Transitional controller `ItineraryDetailsController.tsx`: approximately 14,792 lines; it is explicitly documented as the remaining staging module to split by workflow.
