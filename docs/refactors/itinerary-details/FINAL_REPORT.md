...
- Transitional controller `ItineraryDetailsController.tsx`: 12,906 lines; it is explicitly documented as the remaining staging module to split by workflow.
