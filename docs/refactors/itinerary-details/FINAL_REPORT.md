...
- Transitional controller `ItineraryDetailsController.tsx`: 11,780 lines; it is explicitly documented as the remaining staging module to split by workflow.
