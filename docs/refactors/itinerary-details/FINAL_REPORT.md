...
- Transitional controller `ItineraryDetailsController.tsx`: 12,687 lines; it is explicitly documented as the remaining staging module to split by workflow.
