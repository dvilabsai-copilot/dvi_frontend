...
- Transitional controller `ItineraryDetailsController.tsx`: 4,917 physical lines; it is explicitly documented as the remaining staging module to split by workflow.
