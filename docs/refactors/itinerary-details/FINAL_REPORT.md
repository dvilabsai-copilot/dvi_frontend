...
- Transitional controller `ItineraryDetailsController.tsx`: 11,837 lines; it is explicitly documented as the remaining staging module to split by workflow.
