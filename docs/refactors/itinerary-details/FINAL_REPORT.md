...
- Transitional controller `ItineraryDetailsController.tsx`: 12,086 lines; it is explicitly documented as the remaining staging module to split by workflow.
