...
- Transitional controller `ItineraryDetailsController.tsx`: 13,003 lines; it is explicitly documented as the remaining staging module to split by workflow.
