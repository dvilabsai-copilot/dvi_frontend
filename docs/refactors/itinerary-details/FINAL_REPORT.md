...
- Transitional controller `ItineraryDetailsController.tsx`: 11,841 lines; it is explicitly documented as the remaining staging module to split by workflow.
