...
- Documented blockers: repository-wide lint baseline (1,936 errors/107 warnings), existing unrelated type errors, and 24 broader-suite failures classified in `REGRESSION_LOG.md`.
