...
- Transitional controller `ItineraryDetailsController.tsx`: 3,223 physical lines; it is explicitly documented as the remaining staging module to split by workflow.
