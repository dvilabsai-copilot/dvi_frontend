...
- Transitional controller `ItineraryDetailsController.tsx`: 11,779 lines; it is explicitly documented as the remaining staging module to split by workflow.
