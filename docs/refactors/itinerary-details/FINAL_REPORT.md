...
- Transitional controller `ItineraryDetailsController.tsx`: 11,773 lines; it is explicitly documented as the remaining staging module to split by workflow.
