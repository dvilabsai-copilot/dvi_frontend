...
- Transitional controller `ItineraryDetailsController.tsx`: 2,282 physical lines; it is explicitly documented as the remaining staging module to split by workflow.
