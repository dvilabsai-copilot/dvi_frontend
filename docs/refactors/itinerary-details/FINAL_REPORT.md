...
- Transitional controller `ItineraryDetailsController.tsx`: 14,343 lines; it is explicitly documented as the remaining staging module to split by workflow.
