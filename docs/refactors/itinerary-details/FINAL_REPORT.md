...
- Transitional runtime `ItineraryDetailsRuntime.tsx`: approximately 16,202 lines; it is explicitly documented as the remaining staging module to split by workflow.
