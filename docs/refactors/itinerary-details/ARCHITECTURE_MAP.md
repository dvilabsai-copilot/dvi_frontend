...
- Fit Here confirmation retryability, error-code extraction, expired-attempt classification, and removal/approval analysis are pure helpers in `fitHereConfirm.utils.ts`.
