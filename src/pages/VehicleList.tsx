...
const totalRows = [
 ...
 useEffect(() => {
  ...
  const vehicleListViewContext = {
    ...
    readVehicleGrandTotal, resolveVehicleDisplayAmount, showConfirmDialog,
    setShowConfirmDialog, pendingVendorSelection, setPendingVendorSelection,
    isUpdatingVehicle, handleConfirmSelection,
  };

  return <VehicleListView context={vehicleListViewContext} />;
};
