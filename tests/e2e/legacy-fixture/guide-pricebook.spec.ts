...
const ADMIN_PWD    = process.env.E2E_ADMIN_PASSWORD!;

const GUIDE_ID = process.env.E2E_GUIDE_ID?.trim() ?? '';
...
test.describe('Guide Pricebook – save and display', () => {
  test.beforeEach(() => {
    test.skip(!GUIDE_ID, 'Set E2E_GUIDE_ID for the legacy guide pricebook fixture.');
  });
